...
void EKFGSF_yaw_5state::Log_Write(uint64_t time_us, LogMessages id0, LogMessages id1, LogMessages id2, uint8_t core_index)
{
    if (!vel_fuse_running) {
        return;
    }
    ...
    const struct log_KY1 ky1{
        ...
        time_us                 : time_us,
        core                    : core_index,
        ivn0                    : EKF[0].innov_flow_vel[0],
        ivn1                    : EKF[1].innov_flow_vel[0],
        ivn2                    : EKF[2].innov_flow_vel[0],
        ivn3                    : EKF[3].innov_flow_vel[0],
        ivn4                    : EKF[4].innov_flow_vel[0],
        ive0                    : EKF[0].innov_flow_vel[1],
        ive1                    : EKF[1].innov_flow_vel[1],
        ive2                    : EKF[2].innov_flow_vel[1],
        ive3                    : EKF[3].innov_flow_vel[1],
        ive4                    : EKF[4].innov_flow_vel[1],
    };
    AP::logger().WriteBlock(&ky1, sizeof(ky1));

    const struct log_KY2 ky2{
        LOG_PACKET_HEADER_INIT(id2),
        time_us                 : time_us,
        core                    : core_index,
        ipn0                    : EKF[0].innov_pos[0],
        ipn1                    : EKF[1].innov_pos[0],
        ipn2                    : EKF[2].innov_pos[0],
        ipn3                    : EKF[3].innov_pos[0],
        ipn4                    : EKF[4].innov_pos[0],
        ipe0                    : EKF[0].innov_pos[1],
        ipe1                    : EKF[1].innov_pos[1],
